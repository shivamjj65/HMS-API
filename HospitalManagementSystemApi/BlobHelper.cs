       ...
       Appointment appointment)
        {
            ...
            string fileName = "hms.appointment." + Guid.NewGuid().ToString() + ".json";
...
                    serializer.Serialize(writer, appointment);
                }
            ...
            await PublishToEventGrid(config, appointment);
            return true;
        }

        private static async Task PublishToEventGrid(
   IConfiguration config, Appointment appointment)
        {
            ...
            "HospitalManagementSystem.AppointmentEvent",
            "1.0",
